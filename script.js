...
const categoryData = [
  { title: "Most Popular", subtitle: "All time hits", image: "./brand-preview.png", theme: "theme-blue" },
  { title: "Credit Cards", subtitle: "Best rewards", image: "./logo-option1-premium-v2.png", theme: "theme-sky" },
  { title: "Fashion", subtitle: "Style finds", image: "./myntra-logo.svg", theme: "theme-warm" },
  { title: "Beauty & Grooming", subtitle: "Daily care", image: "./nykaa-logo.svg", theme: "theme-rose" },
  { title: "Electronics", subtitle: "Top gadgets", image: "./croma-logo.svg", theme: "theme-indigo" },
  { title: "Mobiles", subtitle: "Latest phones", image: "./flipkart.png", theme: "theme-pink" },
  { title: "Home & Kitchen", subtitle: "Household picks", image: "./bigbasket.png", theme: "theme-orange" },
  { title: "Min 50% Cashback", subtitle: "Big savings", image: "./logo-minimal-cw-preview.png", theme: "theme-red" },
  { title: "Flights & Hotels", subtitle: "Travel deals", image: "./makemytrip.png", theme: "theme-slate" },
  { title: "More Categories", subtitle: "Explore more", image: "./logo-wordmark.svg", theme: "theme-cyan" },
];
